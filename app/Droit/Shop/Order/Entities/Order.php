...
class Order extends Model{
    ...
    protected $fillable = ['user_id', 'adresse_id', 'coupon_id', 'status','payement_id', 'order_no', 'amount', 'shipping_id', 'paquet','onetimeurl', 'comment','admin','send_at','payed_at','created_at'];
