	...
	public function event(Request $request)
	{
        ...
        $colloques = $colloques->map(function ($colloque, $key) use ($centres){
            ...
            return [
                ...
                'programme'    => isset($colloque->programme) && isset($colloque->programme->path) ? url('files/colloques/programme/'.$colloque->programme->path) : '',
