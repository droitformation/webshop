...
Route::group(['prefix' => 'admin', 'middleware' => ['auth','administration']], function () {
    ...
    Route::group(['middleware' => 'gestion'], function () {
        ...
        */
        ...
        Route::resource('modele', 'Backend\Sondage\ModeleController');
    ...
    /*
    |--------------------------------------------------------------------------
    | Routes not gestion protected for access
    |--------------------------------------------------------------------------
    */
...
Route::group(['prefix' => 'vue'], function () {
    ...
    Route::delete('price_link/{id}/{colloque_id}','Api\PriceLinkController@destroy');
