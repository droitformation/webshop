...
class Cache {
     ...
     * @var string
     */
    protected $timestampKey = 'DroitformationRegistry';

    /**
     * Timestamp Manager (interface)
     *
     * @var null|\Droitformation\Registry\Timestamps\TimestampInterface
     */
    ...
    public function __construct($cachePath, $timestampManager)
    {
        ...
        $this->path = $cachePath.DIRECTORY_SEPARATOR.'droitformation_registry.json';
