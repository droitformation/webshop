...
class Cache {
     ...
     * @var string
     */
    protected $timestampKey = 'DesignPondRegistry';

    /**
     * Timestamp Manager (interface)
     *
     * @var null|\DesignPond\Registry\Timestamps\TimestampInterface
     */
    ...
    public function __construct($cachePath, $timestampManager)
    {
        ...
        $this->path = $cachePath.DIRECTORY_SEPARATOR.'designpond_registry.json';
