...
<div class="main-content" style="page-break-inside: avoid;">
    <div class="content">
    ...
    <div class="content">
        <table class="content-table" valign="top">
            ...
            <tr>
                ...
                <td width="80%" class="comment-attestation">
                    ...
                    @if(isset($colloque->themes) && !empty($colloque->themes))
                        <p style="font-size: 14px; margin-bottom: 5px;"><strong>Thèmes abordés:</strong></p>
                        <div id="themes">
                            {!! $colloque->themes !!}
                        </div>
                    @endif
            ...
            <tr><td colspan="2" height="{{ isset($colloque->themes) && !empty($colloque->themes) ? '5' : '50' }}">&nbsp;</td></tr>
        </table>
