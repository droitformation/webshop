            ...
            <tr class="resetMarge" style="display:block;">
                <td width="600" style="margin: 0;padding: 0;display:block;border: 1px solid #ededed; border-bottom: 0;line-height: 0;">
                    <a href="{{ url('/') }}">
                        ...
                        ?>
                        <img width="{{ $width or '560' }}" height="{{ $height or '100' }}" style="display:block;margin: 0;padding: 0;" alt="{{ $campagne->newsletter->from_name }}" src="{{ secure_asset($campagne->newsletter->banniere_logos ) }}" />
                    </a>
                </td>
            </tr>
            <tr class="resetMarge" style="display:block;">
                <td width="600" class="resetMarge" style="margin: 0;padding: 0;display:block;border: 0; line-height: 0;">
                    ...
                    ?>
                    <img width="{{ $width or '560' }}" height="{{ $height or '100'  }}" alt="{{ $campagne->newsletter->from_name }}" src="{{ secure_asset($campagne->newsletter->banniere_header ) }}" />
                </td>
            </tr>
        </table>
