...
@section('content')
    ...
    <tr>
        <td class="eBody" style="{{ $resetMargin }}padding-top: 12px;padding-bottom: 8px;padding-left: 20px;padding-right: 20px;border-collapse: collapse;border-spacing: 0;-webkit-text-size-adjust: none;font-family: Arial, Helvetica, sans-serif;width: 512px;color: #54565c;border-left: 1px solid #b3bdca;border-right: 1px solid #b3bdca;">
            ...
            <p style="{{$resetMargin}}{{ $resetPadding }}">Après vérification de notre comptabilité, nous nous apercevons que la facture concernant le colloque susmentionné est due.</p>
            ...
            <p style="{{$resetMargin}}margin-bottom: 10px;{{ $resetPadding }}">Merci de bien vouloir prendre connaissance des documents joints et de faire le versement au plus vite. </p>
