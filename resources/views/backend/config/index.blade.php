        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="panel-heading">
                    <h4><i class="fa fa-gears"></i> Informations</h4>
                </div>
                <div class="panel panel-primary">
                    <div class="panel-body">
                        <div class="form-group col-md-4">
                            <label><strong>Vignette</strong></label>
                            <div style="width: 200px;">
                                ...
                                <div class="thumbnail big" ng-if="$flow.files.length">
                                    ...
                                    <input type="hidden" name="inscription[infos][logo]" value="{[{ $flow.files[0].name }]}">
                                </div>
                        ...
                        <div class="col-md-8">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="inscription[infos][tva]" value="{!! Registry::get('inscription.infos.tva')!!}">
                            </div>
                        </div>
                    </div>
