...
<div class="row">
    <div class="col-md-5">
        <a href="{{ url('admin/facture/'.$facture->id) }}" class="btn btn-sm btn-brown"><i class="fa fa-edit"></i></a>
    ...
    <div class="col-md-3 text-right">
        ...
        @else
            <form action="{{ url('admin/rappel') }}" method="POST">{!! csrf_field() !!}
                ...
                <button class="btn btn-warning btn-sm " type="submit">Créer un rappel</button>
            </form>
        @endif
    </div>
</div>
