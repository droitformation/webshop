            ...
            <form action="{{ url('build/campagne/'.$campagne->id) }}" method="POST" class="form-horizontal">
                ...
                <div class="panel-body event-info">
                    ...
                    <div class="form-group">
                        <label class="col-sm-3 control-label"><strong>Visible sur les sites</strong></label>
                        <div class="col-sm-8">
                            <label class="radio-inline"><input type="radio" {{ !$campagne->hidden ? 'checked' : '' }} name="hidden" value="0"> Oui</label>
                            <label class="radio-inline"><input type="radio" {{ $campagne->hidden ? 'checked' : '' }} name="hidden" value="1"> Non</label>
                        </div>
                    </div>
                    <div class="form-group">
