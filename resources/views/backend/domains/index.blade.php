    ...
    <div class="col-md-2">
        <div class="options text-right" style="margin-bottom: 10px;">
            <div class="btn-toolbar">
               <a href="{{ url('admin/domain/create') }}" class="btn btn-success" id="addDomain"><i class="fa fa-plus"></i> &nbsp;Ajouter</a>
            </div>
        </div>
    </div>
</div>
                                ...
                                <tr>
                                    ...
                                    <td class="text-right">
                                        <form action="{{ url('admin/domain/'.$domain->id) }}" method="POST" class="form-horizontal">
                                            ...
                                            <button data-what="Supprimer" data-action="{{ $domain->title }}" class="btn btn-danger btn-sm deleteAction">x</button>
                                        </form>
                                    </td>
                                </tr>
                            @endforeach
