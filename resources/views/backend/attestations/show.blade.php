                ...
                <div class="panel panel-midnightblue">
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                {!! Form::text('signature', $attestation->signature , ['class' => 'form-control']) !!}
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                {!! Form::text('lieu', $attestation->lieu , ['class' => 'form-control', 'required' => 'required']) !!}
                            </div>
                            <div class="col-sm-3"><p class="help-block">Requis</p></div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                {!! Form::text('organisateur', $attestation->organisateur , ['class' => 'form-control', 'required' => 'required']) !!}
                            </div>
                            <div class="col-sm-3"><p class="help-block">Requis</p></div>
                        </div>
