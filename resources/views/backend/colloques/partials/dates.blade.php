...
<div class="form-group">
    ...
    <div class="col-sm-4">
        <input type="text" name="end_at" class="form-control datePicker" value="{{ $colloque->end_at ? $colloque->end_at->format('Y-m-d') : old('end_at') }}">
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-4">
        <input type="text" name="active_at" class="form-control datePicker" value="{{ $colloque->active_at ? $colloque->active_at->format('Y-m-d') : old('active_at') }}">
    </div>
</div>
