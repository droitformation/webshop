        ...
        <section class="row">
            <aside class="col-md-3">
                <ul class="nav nav-list">
                    <li class="active"><a href="#"><i class="fa fa-home"></i> &nbsp;Données</a></li>
                    <li><a href="#"><i class="fa fa-shopping-cart"></i> &nbsp;Commandes</a></li>
                    <li><a href="#"><i class="fa fa-calendar"></i> &nbsp;Inscriptions</a></li>
                </ul>
            </aside>
            <div class="col-md-9">
                ...
                @if(!$user->adresses->isEmpty())
                    @foreach($user->adresses as $adresse)
                        ...
                        <div class="profil-wrapper">
                            <h4>Adresse</h4>
                            <div class="profil-info">
                                <form action="{{ url('adresse/'.$adresse->id) }}" method="POST" class="form">
                                    <input type="hidden" name="_method" value="PUT">
                                    {!! csrf_field() !!}
                                    <div class="row form-group">
