<div class="analyses">
    ...
    <div class="row">
                    ...
                    <div class="analyse arret <?php echo $cats; ?> clear">
                        <div class="post">
                            <div class="post-title">
                                ...
                                <h3 class="title">Analyse de {{ $analyse->authors->implode('name', ', ') }}
                                    @if(isset($analyse->authors))
                                        <?php $authors = $analyse->authors->pluck('name')->toArray(); ?>
                                        <?php echo (!empty($authors) ? implode(',',$authors) : ''); ?>
                                    @endif
                                </h3>
        ...
        <div class="col-md-3 last listCat listAnalyse text-center">
            <img style="max-width: 140px;" border="0" alt="Analyses" src="<?php echo asset('files/pictos/matrimonial/analyse.jpg') ?>">
        </div>
    </div>
