...
<head>
    <meta charset="utf-8">
    <title>Administration | Droit Formation | Accès Spécial</title>
...
<div id="page-container">
    ...
    <!-- Navigation  -->
    @include('access.partials.navigation')

    <div id="page-content">
        <div id='wrap'>

            <div id="page-heading">
                <h2>Droit Formation <small> <span class="text-primary">Accès spécial</span></small></h2>
            </div>
