...
class RabaisTest extends TestCase
{
    ...
    public function testRabaisBiggerThanPriceIsNull()
    {
        $rabais = factory(\App\Droit\Inscription\Entities\Rabais::class)->create(['value' => 1000]);
        ...
        $this->assertTrue($inscription->price_cents == 0);
    }

    public function testRabaisPrice()
    {
        $rabais = factory(\App\Droit\Inscription\Entities\Rabais::class)->create(['value' => 10]);
        ...
        $actual = $price->price_cents - 10;

        $this->assertEquals($actual, $inscription->price_cents);
    }
}
